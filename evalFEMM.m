...
r0 = r(1); r1 = r(2); r2 = r(3); r3 = r(4); r4 = r(5); r5 = r(6); r6 = r(7);
...
% Define Air if Coil Gap
if r2 > r1
    mi_addblocklabel((r1+r2)/2,0)
    mi_selectlabel((r1+r2)/2,0);
